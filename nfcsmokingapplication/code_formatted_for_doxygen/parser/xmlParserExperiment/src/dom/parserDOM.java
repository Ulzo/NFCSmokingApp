...
/*! \brief struct to hold question types -- button/radio, check, or slider
...
/*! \class parserDOM
   \brief This is the primary class for the parser code.
 
   
 */
public class parserDOM {
	
/*! \fn public void getAllQuestions(String fileName)
 *  \brief A member function that extracts all survey questions from the specified XML file.
 ...
 */
	...
	/*! \fn public void printElementText(Element e, String tagName)
 *  \brief A member function.
 *  \param e an Element.
 *  \param tagName a String.
 *  
 *  Prints the text of the tag from the Element to the console.
 */
	...
	/*! \fn public void extractElementText(Element e, String tagName)
 *  \brief A member function.
 *  \param e an Element.
 *  \param tagName a String.
 *  \return The text of the tag from the Element as a String.
 */
...
class Question
{
	...
	int numChoices;		/* !< the number of possible answer choices for the Question */	/**< enum value 2 */
	ArrayList<String> choices = new ArrayList<String>();	/* !< ArrayList of Strings containing the text of each possible answer choice */	//!< a member function.
